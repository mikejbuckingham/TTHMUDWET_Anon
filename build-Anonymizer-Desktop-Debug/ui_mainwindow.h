...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(20, 20, 100, 171));
        ...
        openFolderPushButton = new QPushButton(widget);
